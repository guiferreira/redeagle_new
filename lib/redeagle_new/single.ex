defmodule Redeagle.New.Single do
  ...
  template(:new, [
    ...
    {:keep, "redeagle_phoenix/controllers", :project, "lib/:lib_web_name/controllers"},
    {:eex, "redeagle_phoenix/controllers/info_controller.ex", :project,
     "lib/:lib_web_name/controllers/info_controller.ex"},
    {:eex, "redeagle_phoenix/router.ex", :project, "lib/:lib_web_name/router.ex"},
    {:eex, "redeagle_phoenix/mix.exs", :project, "mix.exs"},
    ...
    {:text, "redeagle_react/src/pages/Home/index.jsx", :project,
     "react/src/pages/Home/index.jsx"},
    ...
    {:text, "redeagle_react/src/styles/global-styles.css", :project,
     "react/src/styles/global-styles.css"},
