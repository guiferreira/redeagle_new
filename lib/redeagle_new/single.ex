defmodule Redeagle.New.Single do
  ...
  template(:new, [
    ...
    {:text, "redeagle_react/src/App.css", :project, "react/src/App.css"},
    {:text, "redeagle_react/src/App.js", :project, "react/src/App.js"},
    {:text, "redeagle_react/src/App.test.js", :project, "react/src/App.test.js"},
    {:text, "redeagle_react/src/index.css", :project, "react/src/index.css"},
    {:text, "redeagle_react/src/index.js", :project, "react/src/index.js"},
    {:text, "redeagle_react/src/logo-elixir.png", :project, "react/src/logo-elixir.png"},
